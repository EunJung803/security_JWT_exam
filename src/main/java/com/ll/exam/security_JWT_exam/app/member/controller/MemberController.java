package com.ll.exam.security_JWT_exam.app.member.controller;
...
//        return Util.spring.responseEntityOf(RsData.of("S-1", "로그인 성공, Access Token을 발급합니다."), headers);
        ...
        return Util.spring.responseEntityOf(
                RsData.of("S-1", "로그인 성공, Access Token을 발급합니다."),   // 내용
                Util.spring.httpHeadersOf("Authentication", "JWT_Access_Token") // 헤더
        );
    }
